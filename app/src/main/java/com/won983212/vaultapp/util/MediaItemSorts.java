...
public class MediaItemSorts {
    ...
    public static final List<Comparator<MediaItem>> COMPARATOR_OBJECTS = Arrays.asList(
            FILE_NAME_ASCENDING, FILE_NAME_DESCENDING, MODIFIED_DATE_ASCENDING, MODIFIED_DATE_DESCENDING,
            VIEW_COUNT_ASCENDING, VIEW_COUNT_DESCENDING, VIDEO_LENGTH_ASCENDING, VIDEO_LENGTH_DESCENDING
    );
